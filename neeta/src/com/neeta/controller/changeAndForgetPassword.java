...
import com.neeta.model.PasswordRecoveryAndChange;


@WebServlet("/admin/changeAndForgetPassword")
public class changeAndForgetPassword extends HttpServlet {
	private static final long serialVersionUID = 1L;
       PasswordRecoveryAndChange prc=new PasswordRecoveryAndChange();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(action_type.equals("ChangePassword"))
		{
			...
			if(new_password.equals(confirm_password))
			{
				...
				boolean success=prc.changePassword(old_password,new_password);
				if(success==true)
		...
		else if (action_type.equals("SendRequest"))
		{
			...
			boolean result=prc.forgetPassword(curr_email);
			if(result==true)
