...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="../admin/css/jquery.ui.timepicker.css">
		<link rel="stylesheet" href="../admin/css/jquery-ui-1.8.24.custom.css" >
    ...
    <body>
		...
		<form name="forgotpassword" id="forgotpassword" class="form-inline label-150" method="post" action="../admin/changeAndForgetPassword" >            
                    <p>
        ...
        <script>window.jQuery || document.write('<script src="../admin/js/jquery-1.8.2.js"><\/script>')</script>
